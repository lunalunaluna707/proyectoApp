...
Widget build(BuildContext context) {
    ...
    body: cargando
        ...
        : RefreshIndicator(
            ...
            child: CustomScrollView(
              ...
              slivers: [
                // AppBar estilo Tareas para Proyectos
                SliverAppBar(
                  pinned: false,
  ...
  child: Container(
    ...
    decoration: const BoxDecoration(
      color: Colors.cyan, // Cambiado de gradiente a color sólido
    ),
  ),
),
                      ...
                      child: TextField(
                        ...
                        onChanged: (value) async {
                          if (value.isEmpty) {
                            ...
                            final resultados =
                                await ApiService.buscarProyectosPorNombre(value);
                            setState(() {
...
// Helper para columnas de resumen
Widget _buildResumenColumn(
    String label, int valor, double screenWidth, double screenHeight) {
  return Column(
    children: [
      Text(
        valor.toString(),
        style: TextStyle(
            fontSize: isLandscape(screenWidth, screenHeight)
                ? screenHeight * 0.03
                : screenWidth * 0.05,
            fontWeight: FontWeight.bold),
      ),
...
// Helper para determinar si es landscape
bool isLandscape(double w, double h) => w > h;
